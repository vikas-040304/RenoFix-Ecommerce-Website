...
class Onboarding {
    ...
    private function get_add_domain_step(): Step
    {
        ...
        $step->set_description( __( 'Every website needs a domain that makes it easy to access and remember. Get ours in just a few clicks.', 'hostinger-easy-onboarding' ) );
    ...
    public static function get_first_step_data(): array
    {
        ...
        if ( get_option( 'template' ) == 'hostinger-ai-theme' ) {
            ...
            if ( empty( $hostinger_ai_version ) ) {
                ...
                $result['primary_button_url'] = admin_url( 'admin.php?page=hostinger-ai-website-creation' );
                ...
                $result['secondary_button_url'] = admin_url( 'admin.php?page=hostinger-ai-website-creation' );
            }
